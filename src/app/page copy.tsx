    ...
    <div className="relative min-h-screen text-white overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <a
          ...
          className="w-full block text-center font-bold py-3 bg-[#F25749] text-[#000000]"
        >
          NUBIT FOR LEARN
        </a>
...
<section id="quiz" className="py-16 px-8 max-w-2xl mx-auto text-center space-y-6">
  <h2 className="text-4xl font-bold mb-4">ThunderBrain Quiz</h2>
    ...
    <div className="mt-6">
      ...
      <div className="space-y-4 text-left mt-6">
          ...
          return (
            <button
              ...
              className={`
                ...
                ${showAnswerAnim && isSelected && !isCorrect ? "bg-red-400 text-white animate-shake" : ""}
              `}
            >
              {opt}
            </button>
        ...
        <button
          ...
          className="mt-4 bg-white text-[#F25749] px-6 py-2 rounded font-bold hover:bg-gray-200 transition disabled:opacity-50"
        >
          Next
        </button>
      </div>
  ...
  {quizFinished && (
    <div className="text-center mt-6">
      <p className="text-2xl font-bold">You scored {score}/{questions.length}!</p>
    </div>
  )}
</section>
        ...
        {/* Leaderboard */}
        <section className="py-16 px-8 max-w-2xl mx-auto text-center space-y-6">
          <h2 className="text-4xl font-bold mb-4">Leaderboard</h2>
          <p>Total users completed: 0</p>
          <ol className="text-left space-y-2">
            <li>1. @example1 — 12/12</li>
            <li>2. @example2 — 11/12</li>
            <li>3. @example3 — 10/12</li>
          </ol>
        </section>

        {/* Footer */}
        <footer className="py-6 text-center">
          <p>© 2025 Nubit ThunderBrain. All rights reserved.</p>
        </footer>
      </div>
    </div>
  );
